...
class MenuScreenState extends State<MenuScreen> {
  ...
  Future<void> refreshAdminStatus() async {
    ...
    // Visible pour le Super Admin, ET pour tout modérateur ayant reçu
    // au moins une permission bien déterminée (sinon rien à modérer).
    if (mounted) {
      setState(() => _hasAdminAccess = isSuperAdmin || permissions.isNotEmpty);
    }
  }
